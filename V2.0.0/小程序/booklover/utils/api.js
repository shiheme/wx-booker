...
module.exports = {
  ...
  getPosts: function(obj) {
    var url = HOST_URI + obj.cnt_tp;

    if (obj.categories != 0) {
      url += '?per_page=' + obj.pageCount + '&orderby=' + obj.orderby + '&order=' + obj.order + '&page=' + obj.page + '&' + obj.cnt_tp +'_cats=' + obj.categories;
    } else if (obj.search != '') {
      url += '?per_page=' + obj.pageCount + '&orderby=' + obj.orderby + '&order=' + obj.order + '&page=' + obj.page + '&search=' + encodeURIComponent(obj.search);
    }
    return url;
  ...
  // 获取内容页数据
  getPostByID: function (id, cnt_tp) {
    var url = HOST_URI + cnt_tp +'/' + id;
    return url;
  },
  ...
  getCategories: function(obj) {
    var url = HOST_URI + obj.cnt_tp + '_cats?per_page=100&orderby=' + obj.orderby + '&order=' + obj.order;
    return url
  },
  //获取某个分类信息
  getCategoryByID: function(id,cnt_tp) {
    var url = HOST_URI + cnt_tp +'_cats/' + id;
    return url;
  },
  //获取某文章评论
  ...
  getMyLikeUrl(obj) {
    var url = HOST_URI_WATCH_LIFE_JSON;
    url += "post/mylike?openid=" + obj.openid + "&cnt_tp=" + obj.cnt_tp;
    return url;
  },
  ...
  getCustomsetBycnttp(obj) {
    var url = HOST_URI_WATCH_LIFE_JSON;
    url += "category/customset_bycnttp";
    if (obj.cnt_tp) {
      url += "?cnt_tp="+obj.cnt_tp;
    }
    return url;
  },
};