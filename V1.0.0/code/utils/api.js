...
module.exports = {
  ...
  getPosts: function(obj) {
    var url = HOST_URI + 'posts?per_page=' + obj.pageCount + '&orderby=' + obj.orderby + '&order=' + obj.order + '&page=' + obj.page;
  ...
  getCategories: function(obj) {
    var url = HOST_URI + 'categories?per_page=100&orderby=' + obj.orderby + '&order=' + obj.order;

    if (obj.cateparentID != '') {
      url += '&parent=' + obj.cateparentID;
    }
    return url
  },
  //获取某个分类信息
